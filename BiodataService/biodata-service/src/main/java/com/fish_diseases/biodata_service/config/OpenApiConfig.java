package com.fish_diseases.biodata_service.config;
...
/**
 * Configura la especificación OpenAPI para el servicio de datos biológicos en FishDiseases.
 *
...
@OpenAPIDefinition(
		info = @Info(
				...
				description = "Documentación OpenApi para datos biológicos en FishDiseases",
		...
		servers = {
		        @Server(
		                ...
		                url = "http://localhost:9000/biodata-service"
		        ),
				@Server(
