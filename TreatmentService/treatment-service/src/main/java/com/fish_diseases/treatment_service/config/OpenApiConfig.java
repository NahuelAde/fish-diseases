package com.fish_diseases.treatment_service.config;
...
/**
 * Configura la especificación OpenAPI para el servicio de tratamientos en FishDiseases.
 *
...
@OpenAPIDefinition(
		info = @Info(
				...
				description = "Documentación OpenApi para tratamientos en FishDiseases",
		...
		servers = {
		        @Server(
		                ...
		                url = "http://localhost:9000/treatment-service"
		        ),
				@Server(
